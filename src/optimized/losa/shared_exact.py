...
def _attention(Q,K,V,P,O,L,
               ...
               BQ:tl.constexpr,BD:tl.constexpr,SCALE):
    row=tl.program_id(0)
...
def attention(q,k,v,pages,*,page_size,prefix_length,softmax_scale=None,query_tile=2,num_warps=4,fusion=True,workspace=None):
    ...
    _attention[(rows,triton.cdiv(heads,query_tile))](
        ...
        num_warps=num_warps,enable_fp_fusion=fusion)
    return out,lse
