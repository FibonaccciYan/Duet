...
from src.model.compat import create_bidirectional_mask
...
from src.model.compat import TransformersKwargs, resolve_rope_scaling
...
from src.model.llada2_1.configuration import LLaDA2MoeConfig
...
class LLaDA2MoeRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: LLaDA2MoeConfig, device=None):
        ...
        self.rope_scaling = resolve_rope_scaling(config)
    ...
    def compute_default_rope_parameters(
        ...
        base = config.rope_scaling.get("rope_theta", getattr(config, "rope_theta", 10000.0))
        partial_rotary_factor = config.rope_scaling.get("partial_rotary_factor", getattr(config, "partial_rotary_factor", 1.0))
