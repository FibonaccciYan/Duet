#!/usr/bin/env python3
"""Measure the integrated batch-size-one FOCUS v2 runtime."""
...
from src.reference.focus import set_seed
from src.optimized.focus import FocusOptimizedRuntime
...
def main() -> int:
    ...
    result = {
        ...
        "moe_expert_patch": True,
        "moe_patch_report": getattr(runtime, "moe_patch_report", None),
    }
