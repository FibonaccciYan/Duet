...
```bash
CUDA_VISIBLE_DEVICES="${GPU:-0}" PYTHONPATH=. python scripts/paper/attention_mass/collect_attention_mass.py \
...
```bash
python scripts/paper/attention_mass/plot_attention_mass.py \
