...
from src.losa_v2.operators import (
    GQAMode,
    V2PageMetadata,
...
from src.losa_v2.triton_ops import (
...
class LoSAV2RuntimeTest(unittest.TestCase):
    def test_runtime_is_registered(self):
        runtime = load_runtime("losa_v2", family="llada")
        self.assertEqual(type(runtime).__name__, "LoSAV2Runtime")
    ...
    def test_triton_fast_paths_match_oracle(self):
        ...
        metadata = V2PageMetadata(k_min, k_max, prefix_length, page_size)
        ...
        expected_scores = quest_page_scores_v2(
